...
\begin{try}[http://hartleymath.com/versatilemath/tryit/\#/logic--translating-english-to-logic-symbols]
Let $p$ and $q$ represent the following simple statements:
\begin{align*}
...
\begin{try}[http://hartleymath.com/versatilemath/tryit/\#/logic--translating-from-symbolic-form]
Let $p$ and $q$ represent the following simple statements:
\begin{align*}
p &: 1+4<5\\
q &: 1+4=5
...
\begin{try}[http://hartleymath.com/versatilemath/tryit/\#/logic--evaluating-a-statement]
...
\begin{try}[http://hartleymath.com/versatilemath/tryit/\#/logic--truth-table-for-p-or-not-q]
...
\begin{try}[http://hartleymath.com/versatilemath/tryit/\#/logic--negating-a-quantified-statement]
