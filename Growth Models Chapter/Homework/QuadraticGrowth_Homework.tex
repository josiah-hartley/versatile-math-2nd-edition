...
\end{center}
\begin{enumerate}[(a)]
\item Use a graphing calculator or spreadsheet program to find a quadratic model that best fits this data, using angle as $t$ and distance as $P_t$.
...
\item What is the smallest angle that you expect to yield a distance of 200 feet?
\end{enumerate}}
...
\item When would you expect the average amount of entertainment time to reach 4000?
\end{enumerate}}
\end{exercises}