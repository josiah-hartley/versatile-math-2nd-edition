...
\begin{try}[http://hartleymath.com/versatilemath/tryit/\#/probability--or-with-rolling-a-die]
...
\begin{example}[https://www.youtube.com/watch?v=uD6AB7t_Das&list=PLfmpjsIzhzts14-9s5QixRje97EI2oeMF&index=11]{Drawing a card}
...
\begin{try}[http://hartleymath.com/versatilemath/tryit/\#/probability--or-with-drawing-a-card-(mutually-exclusive)]
...
\begin{try}[http://hartleymath.com/versatilemath/tryit/\#/probability--or-with-mnms]
...
\begin{example}[https://www.youtube.com/watch?v=lx7DRG6N1r8&list=PLfmpjsIzhzts14-9s5QixRje97EI2oeMF&index=13]{Drawing a card}
...
\begin{try}[http://hartleymath.com/versatilemath/tryit/\#/probability--or-with-drawing-a-card-overlap]
Suppose you draw one card from a standard 52-card deck. What is the probability that you get a Queen or a face card? 
\end{try}

\begin{example}[https://www.youtube.com/watch?v=Z3FKbz7RnSs&list=PLfmpjsIzhzts14-9s5QixRje97EI2oeMF&index=14]{FCC students}
...
\begin{try}[http://hartleymath.com/versatilemath/tryit/\#/probability--selecting-male-or-right-handed-student]
...
\begin{try}[http://hartleymath.com/versatilemath/tryit/\#/probability--selecting-male-or-cardio]
...
\begin{example}[https://www.youtube.com/watch?v=YpjdHUsKaow&list=PLfmpjsIzhzts14-9s5QixRje97EI2oeMF&index=16]{Not hearts!}
...
\begin{try}[http://hartleymath.com/versatilemath/tryit/\#/probability--not-drawing-a-face-card]
...
\begin{try}[http://hartleymath.com/versatilemath/tryit/\#/probability--not-getting-a-multiple-choice-question-correct]
...
\begin{example}[https://www.youtube.com/watch?v=ICbVL7wFRYU&list=PLfmpjsIzhzts14-9s5QixRje97EI2oeMF&index=18]{FCC student demographics}
...
\begin{try}[http://hartleymath.com/versatilemath/tryit/\#/probability--not-selecting-a-full-time-student]
