...
\begin{example}{Identifying Trees}
...
There\marginnote{\emph{for instance, trees can be used to describe games; computer chess programs are an example of an application of this}} are many, many applications of trees, but we will only discuss two of them: \textbf{binary search trees} and \textbf{spanning trees}.
\pagebreak
...
\begin{example}{Building a Binary Search Tree}
...
\begin{example}{Searching with a Binary Search Tree}
...
\begin{example}{Finding a Minimal Spanning Tree}
